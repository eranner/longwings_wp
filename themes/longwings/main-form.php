...
<div class="container form-main">
    ...
    <form class="form-content-holder">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="address" placeholder="John Smith">
        </div>
        <div class="mb-3" style="display:flex; gap: 5px;">
            <div style="display: flex; flex-direction: column;">
                <label for="city" class="form-label">City</label>
                <input type="text" class="form-control" id="city" placeholder="John Smith">
            </div>
            <div style="display: flex; flex-direction: column;">
                <label for="state" class="form-label">State</label>
                <input type="text" class="form-control" id="state" placeholder="John Smith">
            </div>
            <div style="display: flex; flex-direction: column;">
                <label for="zip" class="form-label">Zip</label>
                <input type="text" class="form-control" id="zip" placeholder="John Smith">
            </div>
        </div>
        <div class="mb-3">
            <label for="phone" class="form-label">Phone Number</label>
            <input type="text" class="form-control" id="phone" placeholder="John Smith">
        </div>
